...
#     #         try:
#     #             conn1.run(
#     #                 f"{data_type}([concat(take(`abcd中文123,100000))])[0]:{data_type}([concat(take(`abcd中文123,100000))])[0]")
#     #         except Exception as err:
#     #             assert 'IO error type 4' in str(err)
#     #     else:
#     #         matx = conn1.run(
#     #             f"{data_type}(concat(take(`abcd中文123,100000))):{data_type}(concat(take(`abcd中文123,100000)))")
#     #         assert len(matx) == 2
