...
class TestTable2:
    ...
    def test_temp_table_del(self):
        df = pd.DataFrame(
            {'organization_code': [[False, False, False, True, False]]})
        df2 = pd.DataFrame(
            {'organization_code': [[False, False, False, True, False]]})
        t = self.conn.table(data=df)
        a = t.tableName()
        dbvalue = self.conn.run(
            "select count(*) from objs() where name = '{name}'".format(name=a))
        assert dbvalue["count"][0] == 1
    ...
    def test_temp_table_del_big_data(self):
        ...
        intn = [np.array(np.tile([40, 48, 4, 3, 52, 18, 21, 73, 82, 67], 10000)), np.array(np.tile(
            [36, 98, 95, 69, 41, 60, 78, 92, 78, 21], 10000)), np.array(np.tile([92, 40, 13, 93, 9, 34, 86, 60, 43, 64], 10000))]
        floatn = [np.array(np.tile([40.0, 48.0, 4.0, 3.0, 52.0, 18.0, 21.0, 73.0, 82.0, 67.0], 10000)), np.array(np.tile(
            [36.0, 98.0, 95.0, 69.0, 41.0, 60.0, 78.0, 92.0, 78.0, 21.0], 10000)), np.array(np.tile([92.0, 40.0, 13.0, 93.0, 9.0, 34.0, 86.0, 60.0, 43.0, 64.0], 10000))]
        daten = [
            ...
            pd.to_datetime(np.tile(['1970-04-03', '1970-02-10', '1970-01-14', '1970-04-04', '1970-01-10', '1970-02-04', '1970-03-28', '1970-03-02', '1970-02-13', '1970-03-06'], 10000))]
        datetimen = [
            np.array(np.tile(['1970-01-01T00:00:40', '1970-01-01T00:00:48', '1970-01-01T00:00:04', '1970-01-01T00:00:03', '1970-01-01T00:00:52', '1970-01-01T00:00:18',
                     '1970-01-01T00:00:21', '1970-01-01T00:01:13', '1970-01-01T00:01:22', '1970-01-01T00:01:07'], 10000), dtype=np.datetime64('1970-01-01T00:00:40')),
            np.array(np.tile(['1970-01-01T00:00:36', '1970-01-01T00:01:38', '1970-01-01T00:01:35', '1970-01-01T00:01:09', '1970-01-01T00:00:41', '1970-01-01T00:01:00',
                     '1970-01-01T00:01:18', '1970-01-01T00:01:32', '1970-01-01T00:01:18', '1970-01-01T00:00:21'], 10000), dtype=np.datetime64('1970-01-01T00:00:40')),
            np.array(np.tile(['1970-01-01T00:01:32', '1970-01-01T00:00:40', '1970-01-01T00:00:13', '1970-01-01T00:01:33', '1970-01-01T00:00:09', '1970-01-01T00:00:34', '1970-01-01T00:01:26', '1970-01-01T00:01:00', '1970-01-01T00:00:43', '1970-01-01T00:01:04'], 10000), dtype=np.datetime64('1970-01-01T00:00:40'))]
        timestampv = [
            np.array(np.tile(['1970-01-01T00:00:00.040', '1970-01-01T00:00:00.048', '1970-01-01T00:00:00.004', '1970-01-01T00:00:00.003', '1970-01-01T00:00:00.052', '1970-01-01T00:00:00.018',
                     '1970-01-01T00:00:00.021', '1970-01-01T00:00:00.073', '1970-01-01T00:00:00.082', '1970-01-01T00:00:00.067'], 10000), dtype=np.datetime64('1970-01-01T00:00:00.040')),
            np.array(np.tile(['1970-01-01T00:00:00.036', '1970-01-01T00:00:00.098', '1970-01-01T00:00:00.095', '1970-01-01T00:00:00.069', '1970-01-01T00:00:00.041', '1970-01-01T00:00:00.060',
                     '1970-01-01T00:00:00.078', '1970-01-01T00:00:00.092', '1970-01-01T00:00:00.078', '1970-01-01T00:00:00.021'], 10000), dtype=np.datetime64('1970-01-01T00:00:00.040')),
            np.array(np.tile(['1970-01-01T00:00:00.092', '1970-01-01T00:00:00.040', '1970-01-01T00:00:00.013', '1970-01-01T00:00:00.093', '1970-01-01T00:00:00.009', '1970-01-01T00:00:00.034', '1970-01-01T00:00:00.086', '1970-01-01T00:00:00.060', '1970-01-01T00:00:00.043', '1970-01-01T00:00:00.064'], 10000), dtype=np.datetime64('1970-01-01T00:00:00.040'))]
