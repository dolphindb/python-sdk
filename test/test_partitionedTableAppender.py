...
# -------------------------------------------------------------------------------------------------
    ...
    def test_PartitionedTableAppender_dfs_table_insert_all_datatype_arrayVector(self, _compress):
        ...
        date = np.array(['2021-06-12', '2021-06-13', '2021-06-13',
                        '2021-06-14', '2021-06-14'], dtype="datetime64[ns]")
        sym = ['A1', 'A2', 'A3', 'A4', 'A5']
        ID = np.array([1, 2, 3, 4, 5], dtype="int32")
        bool_av = [[True, False, True, True, False], [True, False, True, True, False], [
            True, False, True, True, False], [True, False, True, True, False], [True, False, True, True, False]]
        char_av = [np.array([1, 2, 3, 4, 5], dtype=np.int8), np.array([1, 2, 3, 4, 5], dtype=np.int8), np.array(
            [1, 2, 3, 4, 5], dtype=np.int8), np.array([1, 2, 3, 4, 5], dtype=np.int8), np.array([1, 2, 3, 4, 5], dtype=np.int8)]
        short_av = [np.array([1, 2, 3, 4, 5], dtype=np.int16), np.array([1, 2, 3, 4, 5], dtype=np.int16), np.array(
            [1, 2, 3, 4, 5], dtype=np.int16), np.array([1, 2, 3, 4, 5], dtype=np.int16), np.array([1, 2, 3, 4, 5], dtype=np.int16)]
        int_av = [np.array([1, 2, 3, 4, 5], dtype=np.int32), np.array([1, 2, 3, 4, 5], dtype=np.int32), np.array(
            [1, 2, 3, 4, 5], dtype=np.int32), np.array([1, 2, 3, 4, 5], dtype=np.int32), np.array([1, 2, 3, 4, 5], dtype=np.int32)]
        long_av = [np.array([1, 2, 3, 4, 5], dtype=np.int64), np.array([1, 2, 3, 4, 5], dtype=np.int64), np.array(
            [1, 2, 3, 4, 5], dtype=np.int64), np.array([1, 2, 3, 4, 5], dtype=np.int64), np.array([1, 2, 3, 4, 5], dtype=np.int64)]
        float_av = [np.array([1, 2, 3, 4, 5], dtype=np.float32), np.array([1, 2, 3, 4, 5], dtype=np.float32), np.array(
            [1, 2, 3, 4, 5], dtype=np.float32), np.array([1, 2, 3, 4, 5], dtype=np.float32), np.array([1, 2, 3, 4, 5], dtype=np.float32)]
        double_av = [np.array([1, 2, 3, 4, 5], dtype=np.float64), np.array([1, 2, 3, 4, 5], dtype=np.float64), np.array(
            [1, 2, 3, 4, 5], dtype=np.float64), np.array([1, 2, 3, 4, 5], dtype=np.float64), np.array([1, 2, 3, 4, 5], dtype=np.float64)]
        date_av = [np.array(["2013-06-13", "2014-06-13", "2015-06-13", "2017-06-13", "2013-06-13"], dtype=np.datetime64("2013-06-13")),
                   ...
                   np.array(["2013-06-13", "2014-06-13", "2015-06-13", "2017-06-13",
                            "2013-06-13"], dtype='datetime64[ns]'),
                   np.array(["2013-06-13", "2014-06-13", "2015-06-13", "2017-06-13", "2013-06-13"], dtype=np.datetime64("2013-06-13"))]
        date_av_expect = [np.array(["2013-06-13", "2014-06-13", "2015-06-13", "2017-06-13", "2013-06-13"], dtype=np.datetime64("2013-06-13")),
                   np.array(["2013-06-13", "2014-06-13", "2015-06-13", "2017-06-13",
        ...
        month_av_expect = [np.array(["2013-06", "2014-06", "2015-06", "2017-06", "2013-06"], dtype=np.datetime64("2013-06")),
                    np.array(["2013-06", "2014-06", "2015-06", "2017-06",
        ...
        datetime_av = [np.array(["2012-06-13T13:30:10", "2014-06-13T13:30:10", "2015-06-13T13:30:10", "2017-06-13T13:30:10", "2013-06-13T13:30:10"], dtype=np.datetime64("2013-06-13T13:30:10")),
                       ...
                       np.array(["2013-06-13T13:30:10", "2014-06-13T13:30:10", "2015-06-13T13:30:10",
                                 "2017-06-13T13:30:10", "2013-06-13T13:30:10"], dtype='datetime64[ns]'),
                       np.array(["2013-06-13T13:30:10", "2014-06-13T13:30:10", "2015-06-13T13:30:10", "2017-06-13T13:30:10", "2013-06-13T13:30:10"], dtype='datetime64[ns]')]
        datetime_av_expect = [np.array(["2012-06-13T13:30:10", "2014-06-13T13:30:10", "2015-06-13T13:30:10", "2017-06-13T13:30:10", "2013-06-13T13:30:10"], dtype=np.datetime64("2013-06-13T13:30:10")),
                       np.array(["2013-06-13T13:30:10", "2014-06-13T13:30:10", "2015-06-13T13:30:10",
                       ...
                       np.array(["2013-06-13T13:30:10", "2014-06-13T13:30:10", "2015-06-13T13:30:10",
                                 "2017-06-13T13:30:10", "2013-06-13T13:30:10"], dtype='datetime64[s]'),
                       np.array(["2013-06-13T13:30:10", "2014-06-13T13:30:10", "2015-06-13T13:30:10", "2017-06-13T13:30:10", "2013-06-13T13:30:10"], dtype='datetime64[s]')]
        timestamp_av = [np.array(["2012-06-13T13:30:10.008", "2014-06-13T13:30:10.008", "2015-06-13T13:30:10.008", "2017-06-13T13:30:10.008", "2013-06-13T13:30:10.008"], dtype='datetime64[ns]'),
                        ...
                        np.array(["2013-06-13T13:30:10.008", "2014-06-13T13:30:10.008", "2015-06-13T13:30:10.008",
                                 "2017-06-13T13:30:10.008", "2013-06-13T13:30:10.008"], dtype='datetime64[ns]'),
                        np.array(["2013-06-13T13:30:10.008", "2014-06-13T13:30:10.008", "2015-06-13T13:30:10.008", "2017-06-13T13:30:10.008", "2013-06-13T13:30:10.008"], dtype='datetime64[ns]')]
        timestamp_av_expect = [np.array(["2012-06-13T13:30:10.008", "2014-06-13T13:30:10.008", "2015-06-13T13:30:10.008", "2017-06-13T13:30:10.008", "2013-06-13T13:30:10.008"], dtype='datetime64[ms]'),
                        np.array(["2013-06-13T13:30:10.008", "2014-06-13T13:30:10.008", "2015-06-13T13:30:10.008",
                        ...
                        np.array(["2013-06-13T13:30:10.008", "2014-06-13T13:30:10.008", "2015-06-13T13:30:10.008",
                                 "2017-06-13T13:30:10.008", "2013-06-13T13:30:10.008"], dtype='datetime64[ms]'),
                        np.array(["2013-06-13T13:30:10.008", "2014-06-13T13:30:10.008", "2015-06-13T13:30:10.008", "2017-06-13T13:30:10.008", "2013-06-13T13:30:10.008"], dtype='datetime64[ms]')]
        nanotimestamp_av = [np.array(["2012-06-13T13:30:10.008007006", "2014-06-13T13:30:10.008007006", "2015-06-13T13:30:10.008007006", "2017-06-13T13:30:10.008007006", "2013-06-13T13:30:10.008007006"], dtype='datetime64[ns]'),
                            np.array(["2013-06-13T13:30:10.008007006", "2014-06-13T13:30:10.008007006", "2015-06-13T13:30:10.008007006",
                                     "2017-06-13T13:30:10.008007006", "2013-06-13T13:30:10.008007006"], dtype='datetime64[ns]'),
                            np.array(["2013-06-13T13:30:10.008007006", "2014-06-13T13:30:10.008007006", "2015-06-13T13:30:10.008007006",
                                     "2017-06-13T13:30:10.008007006", "2013-06-13T13:30:10.008007006"], dtype='datetime64[ns]'),
                            np.array(["2013-06-13T13:30:10.008007006", "2014-06-13T13:30:10.008007006", "2015-06-13T13:30:10.008007006",
                                     "2017-06-13T13:30:10.008007006", "2013-06-13T13:30:10.008007006"], dtype='datetime64[ns]'),
                            np.array(["2013-06-13T13:30:10.008007006", "2014-06-13T13:30:10.008007006", "2015-06-13T13:30:10.008007006", "2017-06-13T13:30:10.008007006", "2013-06-13T13:30:10.008007006"], dtype='datetime64[ns]')]
        df = pd.DataFrame({'date': date, 'sym': sym, 'ID': ID, "bool_av": bool_av, "char_av": char_av, "short_av": short_av, "int_av": int_av,
                           "long_av": long_av, "float_av": float_av, "double_av": double_av, "date_av": date_av, "month_av": month_av, "datetime_av": datetime_av,
                           "timestamp_av": timestamp_av, "nanotimestamp_av": nanotimestamp_av})
        appender = ddb.PartitionedTableAppender(
            "dfs://test", "test", "date", pool)
        appender.append(df)
        time.sleep(2)
        df_expect=pd.DataFrame({'date': date, 'sym': sym, 'ID': ID, "bool_av": bool_av, "char_av": char_av, "short_av": short_av, "int_av": int_av,
                           "long_av": long_av, "float_av": float_av, "double_av": double_av, "date_av": date_av_expect, "month_av": month_av_expect, "datetime_av": datetime_av_expect,
    ...
    @pytest.mark.PARTITIONEDTABLEAPPENDER
    @pytest.mark.parametrize('_compress', [True, False], ids=["COMPRESS_OPEN", "COMPRESS_CLOSE"])
    def test_PartitionedTableAppender_dfs_table_insert_all_datatype_arrayVector_contain_None(self, _compress):
        pool = ddb.DBConnectionPool(
            HOST, PORT, 10, "admin", "123456", compress=_compress)
        # tb=table(1:0,`date`sym`ID`bool_av`char_av`short_av`int_av`long_av`float_av`double_av`date_av`month_av`datetime_av`timestamp_av`nanotimestamp_av,
        #      [DATE,SYMBOL,INT, BOOL[], CHAR[], SHORT[], INT[], LONG[], FLOAT[], DOUBLE[], DATE[], MONTH[], DATETIME[], TIMESTAMP[], NANOTIMESTAMP[]])
        ...
        bool_av = [[np.nan, False, None, True, pd.NaT], [np.nan, False, None, True, pd.NaT], [
            np.nan, False, None, True, pd.NaT], [np.nan, False, None, True, pd.NaT], [np.nan, False, None, True, pd.NaT]]
        char_av = [[np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [
            np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT]]
        short_av = [[np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [
            np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT]]
        int_av = [[np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [
            np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT]]
        long_av = [[np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [
            np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT]]
        float_av = [[np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [
            np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT]]
        double_av = [[np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [
            np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT], [np.nan, 2, None, 4, pd.NaT]]
        # date_av = [np.array(["2014-06-13","2014-06-13","2015-06-13","2017-06-13","2013-06-13"], dtype=np.datetime64("2013-06-13")),
        #            np.array(["2013-06-13","2014-06-13","2015-06-13","2017-06-13","2013-06-13"], dtype=np.datetime64("2013-06-13")),
        #            np.array(["2013-06-13","2014-06-13","2015-06-13","2017-06-13","2013-06-13"], dtype=np.datetime64("2013-06-13")),
        #            np.array(["2013-06-13","2014-06-13","2015-06-13","2017-06-13","2013-06-13"], dtype=np.datetime64("2013-06-13")),
        #            np.array(["2013-06-13","2014-06-13","2015-06-13","2017-06-13","2013-06-13"], dtype=np.datetime64("2013-06-13"))]
        ...
        #             np.array(["2013-06","2014-06","2015-06","2017-06","2013-06"], dtype=np.datetime64("2013-06"))]
        # datetime_av =  [np.array(["2012-06-13T13:30:10","2014-06-13T13:30:10","2015-06-13T13:30:10","2017-06-13T13:30:10","2013-06-13T13:30:10"], dtype=np.datetime64("2013-06-13T13:30:10")),
        #                 np.array(["2013-06-13T13:30:10","2014-06-13T13:30:10","2015-06-13T13:30:10","2017-06-13T13:30:10","2013-06-13T13:30:10"], dtype=np.datetime64("2013-06-13T13:30:10")),
        #                 np.array(["2013-06-13T13:30:10","2014-06-13T13:30:10","2015-06-13T13:30:10","2017-06-13T13:30:10","2013-06-13T13:30:10"], dtype=np.datetime64("2013-06-13T13:30:10")),
        #                 np.array(["2013-06-13T13:30:10","2014-06-13T13:30:10","2015-06-13T13:30:10","2017-06-13T13:30:10","2013-06-13T13:30:10"], dtype=np.datetime64("2013-06-13T13:30:10")),
        #                 np.array(["2013-06-13T13:30:10","2014-06-13T13:30:10","2015-06-13T13:30:10","2017-06-13T13:30:10","2013-06-13T13:30:10"], dtype=np.datetime64("2013-06-13T13:30:10"))]
        # timestamp_av = [np.array(["2012-06-13T13:30:10.008","2014-06-13T13:30:10.008","2015-06-13T13:30:10.008","2017-06-13T13:30:10.008","2013-06-13T13:30:10.008"], dtype=np.datetime64("2013-06-13T13:30:10.008")),
        #                 np.array(["2013-06-13T13:30:10.008","2014-06-13T13:30:10.008","2015-06-13T13:30:10.008","2017-06-13T13:30:10.008","2013-06-13T13:30:10.008"], dtype=np.datetime64("2013-06-13T13:30:10.008")),
        #                 np.array(["2013-06-13T13:30:10.008","2014-06-13T13:30:10.008","2015-06-13T13:30:10.008","2017-06-13T13:30:10.008","2013-06-13T13:30:10.008"], dtype=np.datetime64("2013-06-13T13:30:10.008")),
        #                 np.array(["2013-06-13T13:30:10.008","2014-06-13T13:30:10.008","2015-06-13T13:30:10.008","2017-06-13T13:30:10.008","2013-06-13T13:30:10.008"], dtype=np.datetime64("2013-06-13T13:30:10.008")),
        #                 np.array(["2013-06-13T13:30:10.008","2014-06-13T13:30:10.008","2015-06-13T13:30:10.008","2017-06-13T13:30:10.008","2013-06-13T13:30:10.008"], dtype=np.datetime64("2013-06-13T13:30:10.008"))]
        # nanotimestamp_av = [np.array(["2012-06-13T13:30:10.008007006","2014-06-13T13:30:10.008007006","2015-06-13T13:30:10.008007006","2017-06-13T13:30:10.008007006","2013-06-13T13:30:10.008007006"], dtype=np.datetime64("2013-06-13T13:30:10.008007006")),
        #                     np.array(["2013-06-13T13:30:10.008007006","2014-06-13T13:30:10.008007006","2015-06-13T13:30:10.008007006","2017-06-13T13:30:10.008007006","2013-06-13T13:30:10.008007006"], dtype=np.datetime64("2013-06-13T13:30:10.008007006")),
        #                     np.array(["2013-06-13T13:30:10.008007006","2014-06-13T13:30:10.008007006","2015-06-13T13:30:10.008007006","2017-06-13T13:30:10.008007006","2013-06-13T13:30:10.008007006"], dtype=np.datetime64("2013-06-13T13:30:10.008007006")),
        #                     np.array(["2013-06-13T13:30:10.008007006","2014-06-13T13:30:10.008007006","2015-06-13T13:30:10.008007006","2017-06-13T13:30:10.008007006","2013-06-13T13:30:10.008007006"], dtype=np.datetime64("2013-06-13T13:30:10.008007006")),
        #                     np.array(["2013-06-13T13:30:10.008007006","2014-06-13T13:30:10.008007006","2015-06-13T13:30:10.008007006","2017-06-13T13:30:10.008007006","2013-06-13T13:30:10.008007006"], dtype=np.datetime64("2013-06-13T13:30:10.008007006"))]
        # df = pd.DataFrame({'date': date,'sym': sym, 'ID': ID, "bool_av":bool_av, "char_av":char_av, "short_av":short_av ,"int_av":int_av,
    ...
    def test_PartitionedTableAppender_dfs_table_alltype_arrayvector(self, _compress):
        ...
        df = pd.DataFrame({
            ...
            'long': [np.array([-100000000, 10000000000], dtype=np.int64),np.array([-100000000, 10000000000], dtype=np.int64)],
            'date': [np.array(["1970-01-01T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[D]"),np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[D]")],
            'time': [np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[ms]"),np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[ms]")],
            'minute': [np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[m]"),np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[m]")],
            'second': [np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[s]"),np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[s]")],
            'datetime': [np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[s]"),np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[s]")],
            'datehour': [np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[h]"),np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[h]")],
            'timestamp': [np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[ms]"),np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[ms]")],
            'nanotime': [np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[ns]"),np.array(["1970-01-01T01:02:03.456789123", "1970-01-01T02:05:06.123456789"], dtype="datetime64[ns]")],
            'nanotimestamp': [np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[ns]"),np.array(["2012-02-03T01:02:03.456789123", "2013-04-02T02:05:06.123456789"], dtype="datetime64[ns]")],
            ...
            'ipaddr': [np.array(["192.168.1.1", "0.0.0.0"], dtype='object'),np.array(["192.168.1.1", "0.0.0.0"], dtype='object')],
            'uuid': [np.array(["5d212a78-cc48-e3b1-4235-b4d91473ee87", "5d212a78-cc48-e3b1-4235-b4d914731111"], dtype='object'),np.array(["5d212a78-cc48-e3b1-4235-b4d91473ee87", "5d212a78-cc48-e3b1-4235-b4d914731111"], dtype='object')],
            'int128': [np.array(["e1671797c52e15f763380b45e841ec32", "e1671797c52e15f763380b45e8411112"], dtype='object'),np.array(["e1671797c52e15f763380b45e841ec32", "e1671797c52e15f763380b45e8411112"], dtype='object')]
        })
        num = appender.append(df)
        assert(num == 2)
    ...
    @pytest.mark.PARTITIONEDTABLEAPPENDER
    def test_PartitionedTableAppender_dfs_table_arrayvector_not_match_1(self):
        pool = ddb.DBConnectionPool(HOST, PORT, 10, "admin", "123456")
        self.conn.run('''
        dbPath = "dfs://PartitionedTableAppender_test"
        if(existsDatabase(dbPath))
        ...
        df = pd.DataFrame({
            ...
            'float': [np.array([2.2134500, np.nan], dtype='float32'),np.array([2.2134500, np.nan], dtype='float32')],
            'double': [np.array([3.214, np.nan], dtype='float64'),np.array([3.214, np.nan], dtype='float64')],
            'ipaddr' : [np.array([-100000000, 10000000000], dtype=np.int64),np.array([-100000000, 10000000000], dtype=np.int64)],
            'uuid': [np.array(["5d212a78-cc48-e3b1-4235-b4d91473ee87", "5d212a78-cc48-e3b1-4235-b4d914731111"], dtype='object'),np.array(["5d212a78-cc48-e3b1-4235-b4d91473ee87", "5d212a78-cc48-e3b1-4235-b4d914731111"], dtype='object')],
            'int128': [np.array(["e1671797c52e15f763380b45e841ec32", "e1671797c52e15f763380b45e8411112"], dtype='object'),np.array(["e1671797c52e15f763380b45e841ec32", "e1671797c52e15f763380b45e8411112"], dtype='object')]
        })
        try:
    ...
    @pytest.mark.PARTITIONEDTABLEAPPENDER
    def test_PartitionedTableAppender_dfs_table_arrayvector_not_match_2(self):
        pool = ddb.DBConnectionPool(HOST, PORT, 10, "admin", "123456")
        self.conn.run('''
        dbPath = "dfs://PartitionedTableAppender_test"
        if(existsDatabase(dbPath))
    ...
    @pytest.mark.PARTITIONEDTABLEAPPENDER
    def test_PartitionedTableAppender_dfs_table_arrayvector_not_match_3(self):
        pool = ddb.DBConnectionPool(HOST, PORT, 10, "admin", "123456")
        self.conn.run('''
        dbPath = "dfs://PartitionedTableAppender_test"
        if(existsDatabase(dbPath))
    ...
    @pytest.mark.PARTITIONEDTABLEAPPENDER
    def test_PartitionedTableAppender_dfs_table_arrayvector_not_match_4(self):
        pool = ddb.DBConnectionPool(HOST, PORT, 10, "admin", "123456")
        self.conn.run('''
        dbPath = "dfs://PartitionedTableAppender_test"
        if(existsDatabase(dbPath))
    ...
    def test_PartitionedTableAppender_allNone_tables_with_numpyArray(self, val, valstr, valdecimal):
        ...
        ex_types = ['INT', 'BOOL', 'CHAR', 'SHORT', 'INT', 'LONG', 'DATE', 'MONTH', 'TIME', 'MINUTE',
                    ...
                    'DOUBLE', 'SYMBOL', 'STRING', 'IPADDR', 'UUID', 'INT128', 'BLOB', 'DECIMAL32(0)', 'DECIMAL64(0)', 'DECIMAL128(0)']
    ...
    def test_PartitionedTableAppender_append_dataframe_with_numpy_order(self,_compress,_order,_python_list):
        ...
        for i in range(10):
            row_data = [i, False, i,i,i,i,
                        ...
                        "e1671797c52e15f763380b45e841ec32", decimal.Decimal('-2.11'), decimal.Decimal('0.00000000000'), decimal.Decimal('-1.100000000000000000000000000000000000')]
        ...
        if _python_list:
            df = pd.DataFrame(data,columns=['index', 'cbool', 'cchar', 'cshort', 'cint', 'clong', 'cdate',
                            ...
                            'cdatehour', 'cfloat', 'cdouble', 'csymbol', 'cstring', 'cblob', 'cipaddr', 'cuuid', 'cint128','cdecimal32','cdecimal64','cdecimal128'])
        else:
        ...
        ex_types = ['LONG', 'BOOL', 'CHAR', 'SHORT', 'INT', 'LONG', 'DATE', 'MONTH', 'TIME', 'MINUTE',
                            ...
                            'DOUBLE', 'SYMBOL', 'STRING', 'BLOB', 'IPADDR', 'UUID', 'INT128', 'DECIMAL32(2)', 'DECIMAL64(11)', 'DECIMAL128(36)']
    ...
    @pytest.mark.parametrize('_order', ['F', 'C'], ids=["F_ORDER", "C_ORDER"])
    @pytest.mark.parametrize('_python_list', [True, False], ids=["PYTHON_LIST", "NUMPY_ARRAY"])
    def test_PartitionedTableAppender_append_dataframe_arrayVector_with_numpy_order(self,_compress,_order,_python_list):
        pool = ddb.DBConnectionPool(HOST,PORT,1, 'admin','123456',compress=_compress)
        data = []
        for i in range(10):
            row_data = [i, [False], [i],[i],[i],[i],[i],[i],[i],[i],[i],[i],[i],[i],[i],[i],[i],[i], ["1.1.1.1"], ["5d212a78-cc48-e3b1-4235-b4d91473ee87"],
                        ["e1671797c52e15f763380b45e841ec32"], [decimal.Decimal('-2.11')], [decimal.Decimal('0.00000000000')], [decimal.Decimal('-1.100000000000000000000000000000000000')]]
            data.append(row_data)
        data.append([10, [None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None],[None]])

        if _python_list:
            df = pd.DataFrame(data,columns=['index', 'cbool', 'cchar', 'cshort', 'cint', 'clong', 'cdate',
                            'cmonth', 'ctime', 'cminute', 'csecond', 'cdatetime', 'ctimestamp', 'cnanotime', 'cnanotimestamp',
                            'cdatehour', 'cfloat', 'cdouble', 'cipaddr', 'cuuid', 'cint128', 'cdecimal32', 'cdecimal64', 'cdecimal128'])
        else:
            df = pd.DataFrame(np.array(data,dtype='object',order=_order),columns=['index', 'cbool', 'cchar', 'cshort', 'cint', 'clong', 'cdate',
                            'cmonth', 'ctime', 'cminute', 'csecond', 'cdatetime', 'ctimestamp', 'cnanotime', 'cnanotimestamp',
                            'cdatehour', 'cfloat', 'cdouble', 'cipaddr', 'cuuid', 'cint128', 'cdecimal32', 'cdecimal64', 'cdecimal128'])
        ...
        ex_types = ['LONG', 'BOOL[]', 'CHAR[]', 'SHORT[]', 'INT[]', 'LONG[]', 'DATE[]', 'MONTH[]', 'TIME[]', 'MINUTE[]',
                            'SECOND[]', 'DATETIME[]', 'TIMESTAMP[]', 'NANOTIME[]', 'NANOTIMESTAMP[]', 'DATEHOUR[]', 'FLOAT[]',
                            'DOUBLE[]', 'IPADDR[]', 'UUID[]', 'INT128[]', 'DECIMAL32(2)[]', 'DECIMAL64(11)[]', 'DECIMAL128(36)[]']
        assert_array_equal(tys, ex_types)
        self.conn.dropDatabase("dfs://test_dfs1")
        pool.shutDown()
    ...
    def test_PartitionedTableAppender_append_null_dataframe_with_numpy_order(self,_compress,_order,_python_list):
        ...
        if _python_list:
            df = pd.DataFrame(data,columns=['index', 'cbool', 'cchar', 'cshort', 'cint', 'clong', 'cdate',
                            'cmonth', 'ctime', 'cminute', 'csecond', 'cdatetime', 'ctimestamp', 'cnanotime', 'cnanotimestamp',
                            'cdatehour', 'cfloat', 'cdouble', 'csymbol', 'cstring', 'cblob', 'cipaddr', 'cuuid', 'cint128','cdecimal32','cdecimal64','cdecimal128'],dtype='object')
        else:
            df = pd.DataFrame(np.array(data,dtype='object',order=_order),columns=['index', 'cbool', 'cchar', 'cshort', 'cint', 'clong', 'cdate',
                            'cmonth', 'ctime', 'cminute', 'csecond', 'cdatetime', 'ctimestamp', 'cnanotime', 'cnanotimestamp',
                            'cdatehour', 'cfloat', 'cdouble', 'csymbol', 'cstring', 'cblob', 'cipaddr', 'cuuid', 'cint128','cdecimal32','cdecimal64','cdecimal128'],dtype='object')
        ...
        ex_types = ['LONG', 'BOOL', 'CHAR', 'SHORT', 'INT', 'LONG', 'DATE', 'MONTH', 'TIME', 'MINUTE',
                            'SECOND', 'DATETIME', 'TIMESTAMP', 'NANOTIME', 'NANOTIMESTAMP', 'DATEHOUR', 'FLOAT',
                            'DOUBLE', 'SYMBOL', 'STRING', 'BLOB', 'IPADDR', 'UUID', 'INT128', 'DECIMAL32(0)', 'DECIMAL64(0)', 'DECIMAL128(0)']
        assert_array_equal(tys, ex_types)
        self.conn.dropDatabase("dfs://test_dfs1")
        pool.shutDown()
    ...
    @pytest.mark.parametrize('_order', ['F', 'C'], ids=["F_ORDER", "C_ORDER"])
    @pytest.mark.parametrize('_python_list', [True, False], ids=["PYTHON_LIST", "NUMPY_ARRAY"])
    def test_PartitionedTableAppender_append_null_dataframe_arrayVector_with_numpy_order(self,_compress,_order,_python_list):
        pool = ddb.DBConnectionPool(HOST,PORT,1, 'admin','123456',compress=_compress)
        data = []
        origin_nulls = [[None],[np.nan],[pd.NaT]]
        ...
        if _python_list:
            df = pd.DataFrame(data,columns=['index', 'cbool', 'cchar', 'cshort', 'cint', 'clong', 'cdate',
                            'cmonth', 'ctime', 'cminute', 'csecond', 'cdatetime', 'ctimestamp', 'cnanotime', 'cnanotimestamp',
                            'cdatehour', 'cfloat', 'cdouble', 'cipaddr', 'cuuid', 'cint128', 'cdecimal32', 'cdecimal64', 'cdecimal128'],dtype='object')
        else:
            df = pd.DataFrame(np.array(data,dtype='object',order=_order),columns=['index', 'cbool', 'cchar', 'cshort', 'cint', 'clong', 'cdate',
                            'cmonth', 'ctime', 'cminute', 'csecond', 'cdatetime', 'ctimestamp', 'cnanotime', 'cnanotimestamp',
                            'cdatehour', 'cfloat', 'cdouble', 'cipaddr', 'cuuid', 'cint128', 'cdecimal32', 'cdecimal64', 'cdecimal128'],dtype='object')
    ...
    def test_PartitionedTableAppender_overlength(self):
        ...
        appender = ddb.PartitionedTableAppender(dbPath="dfs://valuedb", tableName="pt", partitionColName="test", dbConnectionPool=pool)
        df=pd.DataFrame({
            'id':['0'*4*64*1024],
            'test':['APPL']
        })
    ...
    def test_PartitionedTableAppender_max_length_blob_dfs_table(self):
        ...
        appender.append(df)
        assert conn.run(f'select strlen(id) from pt')['strlen_id'][0]==4*64*1024
        conn.close()
        pool.shutDown()
