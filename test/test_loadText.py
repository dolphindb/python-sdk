...
class TestLoadTextEx:
    ...
    def test_loadTextEx_dfs_range(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `{DBInfo.table2}, `id, '{self.data1}')")
    ...
    def test_loadTextEx_dfs_value(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `{DBInfo.table2}, `date, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_dfs_list(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `{DBInfo.table2}, `sym, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_dfs_compo_range_range(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `{DBInfo.table2}, `date`id, '{self.data1}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_dfs_compo_range_value(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `{DBInfo.table2}, `date`id, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_dfs_compo_range_list(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `{DBInfo.table2}, `date`sym, '{self.data1}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_dfs_compo_range_hash_list(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `{DBInfo.table2}, `date`id`sym, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_disk_range(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.diskDBName}'), `{DBInfo.table2}, `id, '{self.data1}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_disk_value(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.diskDBName}'), `{DBInfo.table2}, `date, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_disk_list(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.diskDBName}'), `{DBInfo.table2}, `sym, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_disk_compo_range_range(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.diskDBName}'), `{DBInfo.table2}, `date`id, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_disk_compo_range_list(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.diskDBName}'), `{DBInfo.table2}, `date`sym, '{self.data1}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_disk_compo_range_hash_list(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.diskDBName}'), `{DBInfo.table2}, `date`id`sym, '{self.data1}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_disk_compo_range_value_list(self):
        ...
        rs = self.conn.run(
            f"select * from loadTextEx(database('{DBInfo.diskDBName}'), `{DBInfo.table2}, `date`id`sym, '{self.data2}')")
        assert_frame_equal(tmp.toDF(), rs)
    ...
    def test_loadTextEx_sortColumns(self):
        ...
        tmp2 = self.conn.loadTextEx(DBInfo.dfsDBName, 'tb1', partitionColumns=['date'], remoteFilePath=self.data2,
                                    sortColumns=['date', 'id'])
        rs = self.conn.run(f"select * from loadTextEx(database('{DBInfo.dfsDBName}'), `tb1, 'date', '{self.data2}')")
